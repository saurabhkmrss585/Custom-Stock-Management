  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
     ...
     @include("admin_stock_dashboard.aside")
      ...
      color: #333;" >Update Stock - Car/Bike Parts</h2>

            <form action="/add_update_pro/{{$stockupdate->id}}" method="post">
@csrf
            <div class="form-group">
                <label for="productId"></label>
                <input type="text" id="productId" value="{{$stockupdate->id}}" name="id"  hidden>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" id="productName" value="{{$stockupdate->productName}}" name="productName"  required>
              </div>

              <!-- Product Type (Car or Bike Part) -->
              <div class="form-group">
                <label for="productType">Product Type</label>
                <select id="productType" value="{{$stockupdate->productType}}" name="productType"  required>
              ...
              <div class="form-group">
                ...
                <input type="text" id="partNumber"  value="{{$stockupdate->partNumber}}" name="partNumber"  required>
              </div>
              ...
              <div class="form-group-inline">
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="quantity" value="{{$stockupdate->quantity}}"  name="quantity"  min="1" required>
                </div>

                <!-- Price -->
                <div class="form-group">
                  <label for="price">Price per Unit ($)</label>
                  <input type="number" id="price" value="{{$stockupdate->price}}" name="price"  min="0" required>
                </div>
              </div>
