                ...
                <div class="col-xxl-8 mb-6 order-0">
                  <div class="card">
                      <div class="d-flex align-items-start row">
                          <div class="col-sm-7">
                              <div class="card-body">
                                  <h5 class="card-title text-primary mb-3" style="font-size: 1.8rem ; font-weight:bold">Welcome, Admin! </h5>
                                  <p class="mb-6">
                                      Your vehicle parts stock management is in progress!<br />
                                      Ensure that all parts are available for sale to meet customer demand.<br />
                                      For detailed insights, please check the stock reports and monitor your inventory closely.
                                  </p>

                                  <a href="/show_stock" class="btn btn-sm btn-outline-primary">View Stock Data</a>
                              </div>
                          </div>
...
<div class="col-12 col-xxl-8 order-2 order-md-3 order-xxl-2 mb-6">
    <div class="tips-card">
      ...
      <ul class="tips-list">
        <li>Check stock levels weekly.</li>
        <li>Restock popular items early.</li>
        <li>Label everything clearly for easy tracking.</li>
        <li>Use FIFO (First In, First Out) method for perishable goods.</li>
        <li>Monitor inventory turnover rates to optimize stock levels.</li>
      </ul>
    </div>
  </div>
                    ...
                    <div class="col-12 mb-6">
                      <div class="card h-100">
                        <div class="card-body d-flex flex-column justify-content-between">
                          ...
                          <div class="mt-3 ">
                            <a href="/low-stock-alerts" class="btn btn-danger w-100">Urgent Restock</a>
                          </div>
                        </div>
                      </div>
                    </div>
